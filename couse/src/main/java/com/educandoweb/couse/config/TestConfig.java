...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		User u2 = new User(null, "Alex Green", "Alex@gmail.com", "999999998", "123456");
		...
		Category cat3 = new Category(null,"Commputers");
		
		Product p1 = new Product(null,"The lord of the Rings", "Lorem ipsum dolor sit amet, consectetur.", 90.5, "");
		Product p2 = new Product(null,"Smart TV", "Nulla eu imperdiet purus. Maecenas ante.", 2190.0, ""); 
		Product p3 = new Product(null,"Macbook Pro", "Nam eleifend maximus tortor, at mollis.", 1250.0, "");
		Product p4 = new Product(null,"PC Games", "Donec aliquet odio ac rhoncus cursus.", 1200.0, "");
		Product p5 = new Product(null,"Rails for Dummies", "Cras fringilla convallias sem vel faucibus.", 100.99, "");
